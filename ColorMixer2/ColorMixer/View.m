...
- (id)initWithFrame:(CGRect)frame
{
	...
	if (self) {
        ...
        [self installSwitchX: (b.size.width-160) installSwitchY: (b.size.height-330)];
        ...
        greenSliderFrame = [self labelSize: greenLabelSize sliderSize: greenSliderSize boundsRect: b labelCGRect: &greenLabelFrame yIncrement: -50 xIncrement: 0];
